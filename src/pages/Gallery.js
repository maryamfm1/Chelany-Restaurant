  ...
  return (
    <div style={{ backgroundColor: '#fff8f0', color: '#5a2a27', fontFamily: "'Poppins', sans-serif" }} className="aboutus-container py-5">
      <div className="container">
        ...
        >
          {t('about_title')} {/* About Chelany Mitte Restaurant */}
        </h1>
        ...
        <div className="row align-items-center gy-4">
          ...
          <div className="col-md-6 d-flex gap-4 justify-content-center">
            <img
              ...
              alt={t('about_image1_alt')} /* Chelany Restaurant Interior */
              style={{
                width: '48%',
                height: 'auto',
                borderRadius: '15px',
            ...
            <img
              src="/images/bg.jpg"
              alt={t('about_image2_alt')} /* Chef Cooking */
              style={{
                width: '48%',
                height: 'auto',
                borderRadius: '15px',
          ...
          <div className="col-md-6">
            ...
            >
              {[ 
                ...
                <li key={index} style={{ position: 'relative', paddingLeft: '25px', marginBottom: '12px' }}>
                  <span
                    style={{
                      position: 'absolute',
                      left: '0',
